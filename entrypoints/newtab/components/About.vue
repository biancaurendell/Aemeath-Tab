...
<template>
  <base-dialog v-model="opened" acrylic opacity container-class="about__dialog noselect">
    <section>
      <div class="ext-icon">
        <a href="https://aemeath.redlnn.top" target="_blank">
      ...
      <el-space class="ext-links" :size="12">
        ...
        <el-link
          :underline="'never'"
          target="_blank"
          href="https://addons.mozilla.org/firefox/addon/aemeath-new-tab/"
        >
          <el-icon :size="20"><Firefox /></el-icon>
        </el-link>
        <el-link underline="never" target="_blank" href="https://github.com/Redlnn/aemeath-new-tab/">
