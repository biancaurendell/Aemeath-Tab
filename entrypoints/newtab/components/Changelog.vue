    ...
    <div class="changelog-wrapper">
      ...
      <div class="markdown-body" style="padding-top: 21px">
        ...
        <blockquote>
          ...
          <ul>
            <li>
              <a href="https://github.com/Redlnn/aemeath-new-tab/blob/master/docs/CHANGELOG.md">
                {{ t('changelog.otherVersions.linkZhCN') }}
              </a>
            </li>
            <li>
              <a href="https://github.com/Redlnn/aemeath-new-tab/blob/master/docs/CHANGELOG_en.md">
