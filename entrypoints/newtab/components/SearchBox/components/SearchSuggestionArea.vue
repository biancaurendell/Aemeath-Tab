...
const suggestionAreaPerfClass = computed(() => [
  {
    'search-suggestion-area--open': searchSuggestions.value.length > 0,
    'search-suggestion-area--shadow':
      settings.search.style.shadow && searchSuggestions.value.length > 0,
