...
const baseManifest = {
  name: "Aemeath's Tab",
  author: 'Aemeath',
  description: 'A glass new tab customized with Aemeath visuals, music, and pets.',
  default_locale: 'en',
  icons: {
    16: '/icon-16.png',
    24: '/icon-24.png',
  ...
  host_permissions: [
    ...
    'https://api.injahow.cn/', // Aemeath Meting API
  ...
  content_security_policy: {
    extension_pages:
      "script-src 'self'; object-src 'none'; img-src 'self' https: http: data: blob:; media-src 'self' https: http: blob: data:; connect-src 'self' https: http:",
  },
}
